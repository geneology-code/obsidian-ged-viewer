...
export const en: Record<string, string> = {
    ...
    'setting.lifeRangeMode': 'Estimated life range bounds',
    'setting.lifeRangeModeDescription': 'Maximize — earliest birth / latest death. Minimize — latest birth / earliest death.',
    'setting.lifeRangeModeMaximize': 'Maximize',
    'setting.lifeRangeModeMinimize': 'Minimize',
